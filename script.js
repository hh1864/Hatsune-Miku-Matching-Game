...
function onCardFlipped(newlyFlippedCard) {
  ...
  incrementCounter('flips', document.getElementById("flip-count"));
    ...
    lastCardFlipped.element.classList.add("flipped", "border-flipped");
    return;
  }
  ...
  if (!doCardsMatch(lastCardFlipped, newlyFlippedCard)) {
    lastCardFlipped.element.classList.remove("flipped", "border-flipped");
    newlyFlippedCard.element.classList.remove("flipped", "border-flipped");
